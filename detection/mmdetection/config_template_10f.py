def get_config_text(model, fold, work_dir, train_positive=False):
    ...
    if model == 'tood':
        ...
        '        classes=classes,\n', 
        f"        ann_file='../../data/10f_traininglist/train_fold{fold}{suffix}.json'),\n", 
        '    val=dict(\n', 
        "        img_prefix='../../data/images',\n", 
        '        classes=classes,\n', 
        f"        ann_file='../../data/10f_traininglist/test_fold{fold}.json'),\n", 
        '    test=dict(\n', 
        "        img_prefix='../../data/images',\n", 
        '        classes=classes,\n', 
        f"        ann_file='../../data/10f_traininglist/holdout.json'))\n", 
        '\n', 
        '\n', 
